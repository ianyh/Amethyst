...
Amethyst is available for direct download [here](http://ianyh.com/amethyst/versions/Amethyst-0.9.1.zip) or using [homebrew cask](https://github.com/phinze/homebrew-cask).
